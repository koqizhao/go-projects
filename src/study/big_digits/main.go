...
func main() {
    ...
    first_last_line := extensions.MultiplyString(FIRST_LAST_LINE_DIGIT_SEPERATOR, lineLength)

    fmt.Println(first_last_line)

    digitSeperator := extensions.MultiplyString(DIGIT_SEPERATOR, SEPERATOR_SPAN)
